    ...
    [{description,"JSON Services for Defaceit writed on erlang"},
     ...
     {modules,
         [eservices_incoming_mail_controller,
          ...
          eservices_variable_controller,eservices_queue_controller,
          eservices_main_controller,squeue,stoplist,question,
          eservices_view_lib_tags,eservices_custom_filters,
          eservices_custom_tags,eservices_view_main_index_html]},
     {registered,[]},
     ...
     {env,
         [{test_modules,[]},
          ...
          {controller_modules,
              [eservices_question_controller,eservices_variable_controller,
               eservices_queue_controller,eservices_main_controller]},
          ...
          {view_modules,[eservices_view_main_index_html]}]}]}.
